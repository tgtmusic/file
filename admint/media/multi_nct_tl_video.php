...
+ Link post : http://www.nhaccuatui.com/video-am-nhac-viet-nam-nhac-tre.html</p>
...
<textarea class="form-control" name=lyric[<?=$i?>] rows="3" placeholder="Lời Bài Hát"><?=$lyric?></textarea>
...
<?php
	...
	echo "ADD VIDEO Thành công !<meta http-equiv='refresh' content='0;url=index.php?act=media&mode=multi-nct-tl-video'>";
}
}
?>
