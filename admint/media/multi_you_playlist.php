<section class="content">
 ...
 <div class="box box-info">
                <div class="box-header with-border">
                  <h3 class="box-title">Mutil Add Video Playlist Youtube</h3>
...
<form method=post>
  ...
  <p class="margin"><code>Vui lòng nhập link playlist Media muốn thêm</code>				  <br/>
+ Link post : https://www.youtube.com/playlist?list=PLuWB5NPjdvgVqnEq_PsbexB3C9oVJIEQz</p>
...
if (!$_POST['submit']) {
	...
	$url_song = explode('<tr class="pl-video yt-uix-tile "', $url);
...
for ($i=1;$i<=$total_links;$i++) {
    ...
    $song = explode('data-title="', $url_song[$i]);
    $song = explode('"', $song[1]);
    $song = $song[0];
    ...
    $images = 'http://i3.ytimg.com/vi/'.$images[0].'/0.jpg';
?>
...
<?php
	...
	mss ("ADD MEDIA Thành Công! ","index.php?act=media&mode=multi-you-playlist");
