...
});$().ready(function() {     $('#addtopic').click(function() {      return !$('#fromBoxTopic option:selected').remove().appendTo('#topic');     });     $('#removetopic').click(function() {      return !$('#topic option:selected').remove().appendTo('#fromBoxTopic');     });  });
