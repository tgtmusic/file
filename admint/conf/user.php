...
// Them moi
if($act =="add"){
	$username = mysqli_real_escape_string($myFilter->process($_POST["username"]));  if($username == "") $error .= "Enter username please";
	$password = mysqli_real_escape_string($myFilter->process($_POST["password"])); 	if($password == "") $error .= "Enter password please";
	$password = md5(md5($password));
		
	$email = mysqli_real_escape_string($myFilter->process($_POST["email"]));  if($email == "") $error .= "Enter email address please";
		
	$desc = mysqli_real_escape_string($myFilter->process($_POST["desc"]));
	$status = mysqli_real_escape_string($myFilter->process($_POST["status"]));	
...
// Sua
if($act =="update"){
	$id = mysqli_real_escape_string($myFilter->process($_GET["id"]));
	$username = $id;
	
	$email = mysqli_real_escape_string($myFilter->process($_POST["email"]));
	...
	// right
	$r_can = mysqli_real_escape_string($myFilter->process($_POST["r_can"]));
	$m_can = mysqli_real_escape_string($myFilter->process($_POST["m_can"]));
	$r_cus = mysqli_real_escape_string($myFilter->process($_POST["r_cus"]));			
	$m_cus = mysqli_real_escape_string($myFilter->process($_POST["m_cus"]));		
	$right_industry = mysqli_real_escape_string($myFilter->process($_POST["right_industry"]));
	$fullrights = mysqli_real_escape_string($myFilter->process($_POST["fullrights"]));			
