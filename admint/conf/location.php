...
// Them moi
if($act =="add"){
	$thanhpho = mysqli_real_escape_string($myFilter->process($_POST["thanhpho"]));
	if($thanhpho == "") mss("Enter location/city name please","#");
	$sapxep = mysqli_real_escape_string($myFilter->process($_POST["sapxep"]));
	$trangthai = mysqli_real_escape_string($myFilter->process($_POST["trangthai"]));
	$city_intro = mysqli_real_escape_string($_POST["city_intro"]);	
