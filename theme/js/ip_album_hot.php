...
<script type="text/javascript" src="<?php echo SITE_LINK;?>script/jquery-1.7.1.min.js"></script>
		<div class="slide fn-slide-show" >	<div id="bigPic">
		 <div class="slide-body non-opacity"> <div class="slide-scroll fn-slide">
		
				<?php 
                    $hotA = $tgtdb->databasetgt("album_id, album_name, album_singer, album_img","album"," album_type = 0 AND album_hot = 0 ORDER BY album_id DESC LIMIT 5");
