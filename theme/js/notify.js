(function(plugin) {
    ...
    var Message = function(options){
        ...
        this.element = $([
			...
			'<li class="box-alert fn-item ">', 
			'<i class="zicon"></i>', 
			'<p class="fn-content">'+this.options.message+'</p>', 
        ...
        if(!containers[this.options.pos]) {
            containers[this.options.pos] = $('<div class="page-alert '+this.options.pos+'"></div>').appendTo('body').on("click", ".box-alert", function(){
